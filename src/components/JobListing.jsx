    ...
    return (
        <div className="container py-4 d-flex flex-column flex-lg-row gap-3 gap-lg-0">
            ...
            <div className="col-12 col-lg-3 bg-white px-3">
                ...
                <button onClick={() => setShowFilter(prev => !prev)} className="px-4 py-1 border border-secondary rounded d-lg-none">
                        ...
                        {Array.from({ length: Math.ceil(filteredJobs.length / 6) }).map((_, index) => (
                            <a key={index} href="#job-list">
                                <button
                                    ...
                                    className={`btn d-flex align-items-center justify-content-center rounded border ${currentPage === index + 1
